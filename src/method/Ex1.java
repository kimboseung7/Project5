...
public class Ex1 {
	...
	public static void method1() { //돌려줄 값 x --> void --> 그냥 메인 함수 안에 method1(); 만 적으면 출력
	...
	public static String method2(){ // 전달 할 값이 없음 // 반환값은 있으므로 return   -->반환값이 있으므로 대입연산자
	...
	public static void main(String[] args) { //호출 //동작을 하려면 main 함수를 써야함
		...
		String str = method2(); // 선언 = 호출 --> method2 반환값 ok 대입연산자(String)
		...
		//함수 호출이 끝난 후 대입연산자 실행(int) -> 대입 연산자 실행은 맨 마지막
	}	//결과를 저장 할 변수 선언 = 함수 호출
}
// 그니까 메인 안에 있는 호출은 버튼이라고 생각 하면됨,  코드를 메인 안에다가 쓰면 public static 안에 있는 코드가 작동됨
// void가 아닌 반환이 되는 return은 굳이 public static 안에서 사용될 필요x 그니까 메인에서 다시 대입연산자로 써줘야함 
